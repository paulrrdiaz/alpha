...
setTimeout( ()->
    ...
    Utils.prototype.loadStaticFiles = () ->
        ...
        depedencies = [
            'js/modules/all/all.js',
            'js/modules/'+yOSON.controller+'/'+yOSON.controller+'.js',
            'js/libs/yosonjs_utils/modules.js',
            'js/libs/yosonjs_utils/app_load.js'
        ]
        objDependencyManager.ready(depedencies, ->
            log("librerías cargadas con éxito")
        )

    sourcePath = 'frontend/sources/'
